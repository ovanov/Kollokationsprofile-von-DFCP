...
def draw_plot(x_ax, y_ax): # all after dass
    ...
    plt.title("10 häuffigste Kollokatoren pro Position nach phrasaler DFCP")
...
def draw_plot_1dass(x_ax, y_ax, pos): # first pos after dass
    ...
    plt.title("10 häuffigste Kollokatoren von einer phrasalen DFCP")
...
def main():
    freq_collocators = calculate_collocators('~/Tresors/organic/Uni/Almanistik/HS21/Bachelorarbeit/python/kollokationsprofile_daten/10Words/dfcp/phrasal/phrasal_pos.csv')
