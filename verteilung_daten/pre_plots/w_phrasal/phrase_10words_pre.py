...
def draw_plot(x_ax, y_ax): # all after dass
    ...
    plt.title("10 häuffigste Kollokatoren pro Position vor phrasaler DFCP")
...
def main():
    freq_collocators = calculate_collocators('~/Tresors/organic/Uni/Almanistik/HS21/Bachelorarbeit/python/kollokationsprofile_daten/10Words/dfcp/phrasal/phrasal_pre.csv')
